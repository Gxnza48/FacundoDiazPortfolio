...
const Contact = () => {
  ...
  const contacts = [
    {
      platform: "Email",
      value: "facundodiazinmotion@gmail.com",
      link: "mailto:facundodiazinmotion@gmail.com",
      icon: (
    ...
    {
      platform: "LinkedIn",
      value: "linkedin.com/in/facalanda",
      link: "https://linkedin.com/in/facalanda",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    },
    {
        ...
        platform: "Behance",
        value: "behance.net/facalanda",
        link: "https://behance.net/facalanda",
        icon: (
